        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md glass-card rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <h2 className="text-3xl font-bold text-center text-foreground mb-2 tracking-tight">Welcome back</h2>
                    <p className="text-center text-muted-foreground mb-8">Login to manage your expenses</p>
